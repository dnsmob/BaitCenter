...
Pod::Spec.new do |s|
  ...
  s.description  = "An event center meant to work independently from NotificationCenter."
  s.homepage     = "http://github.com/dnsmob/GhostEventCenter"
  s.license      = "MIT"
  s.author       = { "dns sandas" => "eurodns@hotmail.com" }
  s.platform     = :ios, "8.0"
  s.source       = { :git => "http://github.com/dnsmob/GhostEventCenter.git" , :tag => "1.0.1" }
#  s.source       = { :path => '.' }
